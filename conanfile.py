...
class FossilMathConan(ConanFile):
    ...
    description = "Fossil Math is a lightweight, portable math library written in pure C with zero external dependencies."
    topics = ("algebra", "trigonometry", "math", "meson", "fossillogic")
